...
## DMCP5 v3.57 — 2026-05-06

- Stability improvements of Flash/QSPI writes

## DMCP5 v3.56 — 2025-12-02

- Updated System menu confirmation message

## DMCP5 v3.55 — 2025-11-13

- RESET+F4 activates bootloader (USB DFU)

## DMCP5 v3.54 — 2025-10-20

- Fixed USB plug/unplug notification to running program
- Added QR code functions to interface
- KBD test update

## DMCP5 v3.53 — 2025-09-19
